...
gh-add-topics:
  gh repo edit --add-topic "streams-agent,monarchinitiative,linkml"
...
gh-invite-the-dragon:
  gh api repos/microbiomedata/streams-agent/collaborators/dragon-ai-agent -X PUT -f permission=push
